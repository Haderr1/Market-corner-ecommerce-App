...
import { Loader2, Minus, Plus, ShoppingBagIcon, Trash, Trash2 } from "lucide-react";
...
export default function Cart() {
	...
	if (!cartData?.data?.products?.length) {
		return <div className="p-8 flex flex-col justify-center items-center gap-2 h-screen"><ShoppingBagIcon className="text-primary w-30 h-50"/> Cart is empty <Link href='/products'><Button> Add Products </Button></Link></div>;
	}
	return (
		<>
			{isLoading ||
